...
| `VarsDialog` | Blocking confirmation | **Not actually used anywhere in the app** — every screen uses `components/ConfirmModal.tsx` instead. Built but never adopted; see the "Known deviation" note above | Long forms or WebViews | neutral/info/warning/danger, visible/hidden |
