...
const styles = StyleSheet.create({
  ...
  modeToggle: { flexDirection: 'row', backgroundColor: Colors.surface, borderRadius: 12, padding: 4, marginBottom: 24 },
  ...
  form: { gap: 12 },
  input: { height: 54, borderWidth: 1.5, borderColor: Colors.border, borderRadius: 14, paddingHorizontal: 16, fontSize: 16, color: Colors.text },
  helper: { fontSize: 13, color: Colors.textSecondary, marginTop: -4, marginLeft: 4 },
  button: { height: 54, backgroundColor: Colors.primary, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
