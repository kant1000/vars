...
const s = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: 'transparent', borderRadius: 5, padding: 16, borderWidth: 1, borderColor: Colors.ink },
  ...
  statusPill: { borderRadius: 5, paddingHorizontal: 8, paddingVertical: 2, borderWidth: 1, borderColor: Colors.inkFaint },
