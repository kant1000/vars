            ...
            <View key={p.id} style={s.row}>
              ...
              <View style={{ alignItems: 'flex-end', gap: 4 }}>
                ...
                <View style={s.statusPill}>
                  <Text style={[s.statusText, { color: STATUS_COLOR[p.status] ?? Colors.inkMuted }]}>
                    {p.status}
                  </Text>
                </View>
              </View>
...
const s = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: 'transparent', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: Colors.ink },
  ...
  statusPill: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2, borderWidth: 1, borderColor: Colors.inkFaint },
