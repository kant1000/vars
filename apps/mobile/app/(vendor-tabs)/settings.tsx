    ...
    <View style={[s.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={s.card}>
          <TouchableOpacity
            style={s.row}
            onPress={() => WebBrowser.openBrowserAsync('https://bookwithvars.com/terms')}
            activeOpacity={0.7}
          >
          ...
          <TouchableOpacity
            style={[s.row, s.lastRow]}
            onPress={() => WebBrowser.openBrowserAsync('https://bookwithvars.com/privacy')}
            activeOpacity={0.7}
          >
